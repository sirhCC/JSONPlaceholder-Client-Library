...
exports.demonstrateDeveloperExperience = demonstrateDeveloperExperience;
...
async function demonstrateDeveloperExperience() {
    ...
    const client = new client_1.JsonPlaceholderClient('https://jsonplaceholder.typicode.com', {
        devModeConfig: {
            enabled: true,
            verboseLogging: true,
...
async function demonstrateErrorHandling() {
    ...
    const client = new client_1.JsonPlaceholderClient('https://invalid-api-endpoint.com', {
